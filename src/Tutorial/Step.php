...
class Step
{
    ...
    public function __construct(string|\Closure $title, null|string|\Closure|HtmlString|View $description = null)
    {
    ...
    public static function make(string|\Closure $title, null|string|\Closure|HtmlString|View $description = null): static
    {
